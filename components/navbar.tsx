...
export const NavBar = () => {
  ...
  return (
    <nav className="h-[66px] flex justify-between items-center border bg-[#FDFDFD] w-full">
      <div className="m-4">
        <h2 className="text-xl font-bold">Dashboard</h2>
      </div>
      <div className="flex items-center gap-4 mx-2">
        <div className="relative flex items-center">
          <SVGSearch className="absolute ml-2" />
          <Input
            placeholder="search..."
            className="ring-0 pl-8 focus:border-none h-8 rounded-full outline-none bg-white focus-visible:ring-0"
          />
        </div>
        <div>
          <Popover>
